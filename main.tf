...
module "db" {
  ...
  master_password                       = var.manage_master_user_password ? null : (var.master_password != null ? var.master_password : random_password.root_password.result) #var.master_password == null ? random_password.root_password.result : var.master_password
...
resource "aws_secretsmanager_secret_version" "db" {
  ...
  secret_string = jsonencode({
    ...
    password = var.master_password != null ? var.master_password : random_password.root_password.result #var.master_password == null ? random_password.root_password.result : var.master_password  # random_password.root_password.result #module.db.cluster_master_password
  })
}
